...
the following dependencies should be installed:
    ...
    sudo apt install -y git python3-pip python3-scipy python3-numpy python3-rpi.gpio sox gnuplot libsox-fmt-all ffmpeg libasound-dev libportaudio2 && pip install requests playsound numpy sounddevice Unidecode 
